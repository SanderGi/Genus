// Draw a combinatorial oriented graph embedding to a 2D drawing of its corresponding fundamental polygon. Also supports 3D output curtesy of Alexander Metzger.
...
// compile cc -O4 -o planar_draw  planar_draw.c -lm
...
void write_obj(double coord[][2])
{
  ...
  fprintf(obj,"# canonical handle surface generated by planar_draw\n");
